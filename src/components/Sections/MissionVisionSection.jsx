...
import missionImage from '../../assets/3dimage.png';
import visionImage from '../../assets/3dimage.png';
...
const MissionVisionSection = () => {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-0">
          <div className="grid grid-cols-1 items-center gap-y-10 gap-x-12 lg:grid-cols-2">
            ...
            <div className="flex justify-center lg:justify-end">
              <img
                className="w-full max-w-md lg:max-w-lg rounded-xl object-cover shadow-xl"
                src={missionImage}
      ...
      {/* Our Vision Section */}
      <section className="py-6 sm:py-8 md:py-12 bg-baltic-900 text-white font-montserrat">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-0">
          <div className="grid grid-cols-1 items-center gap-y-10 gap-x-12 lg:grid-cols-2">
            ...
            <div className="lg:pl-4 text-center lg:text-left">
              ...
              <p className="mt-4 text-base sm:text-lg leading-relaxed text-baltic-200">
                Lorem ipsum dolor sit amet consectetur. Egestas commodo aliquam
