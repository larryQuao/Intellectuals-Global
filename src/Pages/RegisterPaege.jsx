...
const programsOfStudy = [
  ...
  { value: 'BSc Information System', label: 'BSc Information Systems' },
...
// Your actual Web App URL is correctly placed here
...
const RegisterPage = () => {
  ...
  // The rest of your JSX for the form remains the same
  return (
        ...
        <div className="mt-10 sm:mt-12 max-w-xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  type="tel" name="phone" id="phone" autoComplete="tel" required
            ...
            <div>
              <button
                ...
                className="flex w-full justify-center rounded-md bg-violet-600 px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-violet-600 disabled:opacity-50"
              >
